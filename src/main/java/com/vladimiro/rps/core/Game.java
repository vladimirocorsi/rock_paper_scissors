...
public class Game {
	...
	/**
	 * A game with two players and an {@link ExecutorService} to parallelize the
	 * request for symbols. Can be useful when playing computer vs computer with
	 * time consuming {@link ComputerStrategy}.
	 * 
	 * @param player1
	 * @param player2
	 * @param executor
